"""Test DB layer: init_db bikin 25 tabel sesuai schema (11 Phase A + 3 forward-layer + 7 Phase J+ equity expansion + 1 lane_validation_log + 3 News Threads Addendum B)."""
...
def test_init_db_idempotent(tmp_path):
    ...
    init_db(db_file)
    assert len(list_tables(db_file)) == 25
